...
<div style={{ height: 1, background: "rgba(255,255,255,0.08)" }} />
 ...
 {navItems.map(tab =>(
<button key={tab.id} onClick={() =>{ if (tab.id === "guidelines") { window.open('/faculty-appraisal-guidelines.pdf', '_blank'); return; } setActiveMainTab(tab.id); setReviewingApproval(null); setSelectedSchoolCode("all"); }}
